...
const PROFILES: ProfileDefinition[] = [
  ...
  makeProfile(
    ...
    "KORU Official DdeolsaoPal v1",
    "Official Yahoo adjusted-close research baseline for the KORU daily-close strategy.",
    "KORU",
    5,
    40,
    "adjusted_close",
  ...
  makeProfile(
    ...
    "koru_default_7x30",
    "KORU Default 7x30",
    "KORU daily-close comparison profile with 7 threads and 30-session stops.",
    "KORU",
    7,
    30,
    "adjusted_close",
  ...
  makeProfile(
    ...
    "koru_default_5x30",
    "KORU Default 5x30",
    "Baseline KORU daily-close comparison profile.",
    "KORU",
    5,
    30,
    "adjusted_close",
  ...
  makeProfile(
    ...
    "koru_best_avg_5x40",
    "KORU Best Avg 5x40",
    "Reference profile for the higher-return KORU comparison cell.",
    "KORU",
    5,
    40,
    "adjusted_close",
